...
public class gatherDataDSW {
      ...
      * @param pathsReplies HashMap with uuid for each question path in DSW
      * @param DSWReplies HashMap with uuid of a question as key and JSONObject with reply as value
      * @param requiredLevels HashMap with the required Level for each attribute path
      * @param answerReply JSONObject with the mapping for the values of the UUID code for each reply
      * @return
      */
    ...
    Map<String, JSONObject> DSWReplies, Map<String, String> requiredLevels, JSONObject answerReply) {
      ...
      * @param attributePath The path of the Attribute to get the Reply
      * @param previousPath The Path from the previous level in the Mapping
      * @param values HashMap with reply values for a given category and DSWFile
      * @param DSWReplies HashMap with uuid of a question as key and JSONObject with reply as value
      * @param answerReply JSONObject with the mapping for the values of the UUID code for each reply
      */
